...
[![部署演示视频](docs/sisu-demo-poster.png)](https://github.com/hyuhan666-art/sisu-libaray-project-main/raw/main/docs/sisu-demo.mp4)

> ▶️ **点击上方截图查看完整演示视频**（含语音讲解，登录 → 图书检索 → 借书 / 还书 → 管理后台统计）。
