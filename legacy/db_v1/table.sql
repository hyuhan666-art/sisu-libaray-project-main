...
select
    ...
    (select group_concat(distinct b2.author order by count(*) desc separator ', ')
     ...
     group by b2.author
     limit 3) as favorite_authors_in_category
...
-- ---------------------------------------------------------------------------
-- [新增] 存储过程 5：创建预约 (sp_create_reservation)
--   参数：
--     IN  p_user_id       - 用户ID
--     IN  p_book_id       - 图书ID
...
-- ---------------------------------------------------------------------------
-- [新增] 存储过程 6：取消预约 (sp_cancel_reservation)
--   参数：
...
-- ---------------------------------------------------------------------------
-- [新增] 存储过程 7：读者注册 (sp_register_reader)
--   参数：
--     IN  p_username         - 用户名
...
-- ---------------------------------------------------------------------------
-- [新增] 存储过程 10：损坏登记 (sp_report_damaged)
--   参数：
--     IN  p_copy_id      - 图书副本ID
--     IN  p_operator_id  - 操作员ID
--     IN  p_notes        - 备注
...
-- ---------------------------------------------------------------------------
-- [新增] 存储过程 11：丢失登记 (sp_report_lost)
--   参数：
--     IN  p_copy_id      - 图书副本ID
--     IN  p_operator_id  - 操作员ID
--     IN  p_notes        - 备注
